                    ...
                    .map((cita) => (
                      <div key={cita._id} className="admin-appt-card">
                        <div className="admin-appt-card__header">
                          <span className="admin-appt-card__hour">
                            {cita.slot_id.hour}
                          </span>
                          <span
                            className={`badge ${getStateBadge(cita.state).cls}`}
                          >
                            {getStateBadge(cita.state).label}
                          </span>
                        </div>
                        <div className="admin-appt-card__body">
                          <div className="admin-appt-card__row">
                            <span className="admin-appt-card__label">
                              Cliente
                            </span>
                            <span className="admin-appt-card__value">
                              {cita.client_id.name}
                            </span>
                          </div>
                          <div className="admin-appt-card__row">
                ...
                <div key={e._id} className="admin-appt-card">
                  ...
                  <div className="admin-appt-card__body">
                    <div className="admin-appt-card__row">
                      ...
                      <span className="admin-appt-card__value">
                        {new Date(e.slot_id.date).toLocaleDateString("es-ES")}
                      </span>
                    </div>
                    <div className="admin-appt-card__row">
